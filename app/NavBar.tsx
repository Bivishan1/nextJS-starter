...
const NavBar = () => {
  ...
  return (
    <div className="flex space-x-8 bg-slate-300 p-3">
      ...
      {/* we give here ! cause we are telling compiler that when status === 'loading' we don't have user object, but when authenticated, we def. have a user object, that's why we are telling to TS compiler that we def. have a user */}
